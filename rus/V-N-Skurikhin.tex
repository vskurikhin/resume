...
\begin{document}
\name{Виктор Скурихин}
\tagline{Руководитель направления разработки}
\personalinfo{%
  % Not all of these are required!
  % You can add your own with \printinfo{symbol}{detail}
  \email{vskurikhin@gmail.com}
  \phone{+79015499556}
  \location{Москва, Россия}
  \github{github.com/vskurikhin/resume}
...
\begin{itemize}
\item Поддерживал промышленные операционные системы AIX, RHEL, Solaris.
\end{itemize}
